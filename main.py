...
from app.routes import osint_scrapper, subdir_enumerator, subdom_enumerator, vuln_scanner
app = Flask(
...
app.register_blueprint(vuln_scanner.vuln_scanner, url_prefix="/vuln_scanner")
